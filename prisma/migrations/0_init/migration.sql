...
-- AddForeignKey
ALTER TABLE "invitation" ADD CONSTRAINT "invitation_team_member_id_fkey" FOREIGN KEY ("team_member_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
